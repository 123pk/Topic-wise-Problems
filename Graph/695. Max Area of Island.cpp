/*
Platform :- Leetcode
Approach :- We do bfs from each of the long as long we can go and count the area , we donnot visit visited areas and water , we maintain onoe visited 2d array for that.
*/
class Solution {
public:
